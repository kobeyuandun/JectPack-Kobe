package com.jetpack.kobe.ui.main.tab
...
import com.jetpack.kobe.databinding.FragmentTabBinding
import com.jetpack.kobe.view.MagicIndicatorUtils
import com.zs.zs_jetpack.ui.main.tab.ArticleListFragment
import com.zs.zs_jetpack.ui.main.tab.TabVM
 ...
 * @date 2020-05-14
 */
class TabFragment : LazyFragment<FragmentTabBinding>() {
